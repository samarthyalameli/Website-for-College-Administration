...
$sql = "SELECT * FROM studentdetails where pid = '$uid' ";
...
<nav class="navbar navbar-expand-sm navbar-dark sticky-top" style=" background-color:  #293d3d; ">
  ...
  <ul class="navbar-nav" style="color: white; ">
    ...
    <li class="nav-item">
      <a class="nav-link" href="studentlogin">Results</a>
    </li>
<li class="nav-item">
...
<div style="  left: 0; right: 0; position:absolute;">
  ...
  <li class="nav-item" style="padding: 7px 10px;">
    <a class="nav-link " href="main.php"><i class="fas fa-bus-alt" style="color: brown;"></i><b style="color: #999999;">  About</b></a>
  </li>
</ul>
...
<div class="col-sm-6 col-md-10" style="border: solid 1px;border-color: red;padding: 10px;  ">
  <h2 style="text-align: center;font-size:50px; "><b>Report Details</b></h2>
