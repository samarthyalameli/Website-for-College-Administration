...
<li class="nav-item">
      <a class="nav-link" href="#" >Student/Parents Login</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu ">
        ...
        <a class="dropdown-item" href="#">Information Science</a>
...
<li class="nav-item" >
      <button type="button" class="btn btn-info" style="margin-right: 20px; " onclick="window.location.href='index.php'">Login</button>
    </li>
  </ul>
</nav>
